      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <NavLink to="/expenses" className="text-white hover:text-gray-300">Expenses</NavLink>
            <NavLink to="/rentals" className="text-white hover:text-gray-300">Rentals</NavLink>
          </div>
        </div>
      </div>
    </nav>
